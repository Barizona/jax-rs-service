...
public class ProductResource {
	...
	public String getProductsHTML() {
		...
		try {
			...
			File JSONfile = new File("/Users/Bart/Desktop/Product.json");
			//File XMLfile = new File("/Users/Bart/Desktop/Products.xml");
			...
			for(Product product : listOfProducts) {
				...
				htmlString += "<b>Name : " + product.getShortname() + "</b><br>";
	...
	public String getProductsJSON() {
		...
		try {
			JAXBContext jaxbContext1 = JAXBContext.newInstance(ProductsXML.class);
			Unmarshaller jaxbUnmarshaller = jaxbContext1.createUnmarshaller();
			File XMLfile = new File("/Users/Bart/Desktop/Product.json");
			...
			for(Product product : listOfProducts) {
				...
				jsonString += "{\"name\" : \"" + product.getShortname() + "\",";
